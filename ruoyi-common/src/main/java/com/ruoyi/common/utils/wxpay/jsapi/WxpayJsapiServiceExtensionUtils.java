package com.ruoyi.common.utils.wxpay.jsapi;
 ...
 */
public class WxpayJsapiServiceExtensionUtils {
  private final Signer signer;
  private final String signType;
  private final JsapiService jsapiService;
  private static final Logger logger = LoggerFactory.getLogger(WxpayJsapiServiceExtensionUtils.class);

  private WxpayJsapiServiceExtensionUtils(
  ...
  public static class Builder {
    ...
    public WxpayJsapiServiceExtensionUtils build() {
      return new WxpayJsapiServiceExtensionUtils(
