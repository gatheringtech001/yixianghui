...
public class SysAuthController extends BaseController
{
    ...
    {
        auths.put("gitee", "{\"clientId\":\"EXAMPLE_CLIENT_ID\",\"clientSecret\":\"EXAMPLE_CLIENT_SECRET\",\"redirectUri\":\"http://127.0.0.1:80/social-login?source=gitee\"}");
        auths.put("github", "{\"clientId\":\"EXAMPLE_CLIENT_ID\",\"clientSecret\":\"EXAMPLE_CLIENT_SECRET\",\"redirectUri\":\"http://127.0.0.1:80/social-login?source=github\"}");
