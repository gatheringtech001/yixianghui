        ...
        <pane size="84">
          <el-col>
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
              ...
              <el-table-column label="现居住地址" align="center" key="liveAddress" prop="liveAddress" v-if="columns[5].visible" min-width="140" :show-overflow-tooltip="true" />
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="现居住地址">
              <el-input v-model="form.liveAddress" type="textarea" placeholder="请输入现居住地址"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 5, label: `现居住地址`, visible: false },
